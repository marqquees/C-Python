...
void ocorrencia(int matriz[][MAX_C], int matriz_ocorr[][2])
{
    ...
    for (int linha = 0; linha < MAX_L; linha++)
    {
        for (int coluna = 0; coluna < MAX_C; coluna++)
        {
            ...
            {
                // Armazena o valor.
                matriz_ocorr[numero_elemento][0] = matriz[linha][coluna];
                // Inicializa a contagem como 1.
                matriz_ocorr[numero_elemento][1] = 1;
                // Incrementa o contador de elementos únicos.
                numero_elemento++;
            }
        }
    }
